  ...
  return (
      <div className='p-4 '>
          <div className="flex mb-3">
              <img src="https://i.pinimg.com/474x/8b/c8/37/8bc8378a740f93b9dab9b28d14cd3acf.jpg" alt="" className='w-1/2 h-1/2 mr-1 rounded-2xl' />
              <img src="https://i.pinimg.com/474x/5d/f9/cb/5df9cb8c93dea92af643e4833878debd.jpg" alt="Raw Vegetables" className='w-1/2 h-1/2 rounded-2xl' />
          </div>
          ...
          <p>
              ...
              <br />              Can be reused anytime and have no expiration date.
              <br />             Available PDF download of entire Meal Plan.
              <br />   Immediately available after purchase.
              <br />  Printable weekly shopping lists.
              <br /> View each day’s meals on Fitness Blender’s customizable calendar.
              <br />   Exact amount of ingredients for 5 daily calorie allotments.
              <br /> Additional Notes
              <br />   Sales of Meal Plans are used to keep the workout videos and other content free. 100% of all plan sales go back to adding features and content to the website.
              <br />Recipes use U.S. measuring conventions: e.g. cups, teaspoons, tablespoons. Conversions to metric or other measuring systems are not included, but can be found online.
              <br />Ingredients can be commonly found in U.S. grocery stores. If particular ingredients cannot be found where you live, substitutions will be necessary. The guide also includes a chapter on modifications for food preference and availability.
              <br />     Meal Plans are a non-refundable purchase.
              <br />If you ever have any questions about accessing a purchased program, we are happy to help. Fill out our Contact Us form or email us at service@fitnessblender.com
              <br />For long-time Fitness Blender users, our calendar-based Meal Plans are unique from our eBook/PDF programs. These older programs do not crossover to the new calendar.
          </p>
    </div>
  )
}

export default Indiet5
